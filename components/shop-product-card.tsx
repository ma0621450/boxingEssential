      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-border/50 gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground text-sm font-semibold rounded-xl hover:bg-primary/90 transition-transform active:scale-95 ml-auto"
            target="_blank"
