...
export const categories: Category[] = [
  ...
  },
  {
    slug: "news",
    name: "News",
    description: "Latest boxing news, fight results, rankings, and world boxing updates.",
    articleCount: 12,
  },
];
...
export const Blogs: Article[] = [
  ...
  {
    slug: "heavyweight-title-clash-confirmed",
    title: "Heavyweight Title Clash: Champion to Defend Belt in September",
    excerpt: "The long-awaited heavyweight unification bout has finally been signed. Both champions will meet in the ring this September in London.",
    content: "<p>The boxing world was set abuzz today with the official announcement of the heavyweight unification clash scheduled for September. After months of intense negotiations, contracts have been signed for what many are calling the fight of the decade.</p>",
    category: categories[5],
    author: "Tony Delgado",
    date: "2025-05-15",
    readTime: "5 min read",
    featuredImage: "https://images.pexels.com/photos/4761779/pexels-photo-4761779.jpeg?auto=compress&cs=tinysrgb&w=800",
    featured: true,
  },
  {
    slug: "rising-star-knockout-victory",
    title: "Rising Star Secures Stunning Second-Round Knockout Victory",
    excerpt: "The young prospect continued their undefeated streak with a clinical performance last night, finishing the veteran opponent early in the second.",
    content: "<p>The middleweight division has a new serious contender. Last night at the MGM Grand, we witnessed a masterclass in power and precision as the 22-year-old rising star dismantled their opponent in less than six minutes.</p>",
    category: categories[5],
    author: "Marcus Rivera",
    date: "2025-05-14",
    readTime: "4 min read",
    featuredImage: "https://images.pexels.com/photos/4761783/pexels-photo-4761783.jpeg?auto=compress&cs=tinysrgb&w=800",
    featured: false,
  },
  {
    slug: "world-rankings-update-june-2025",
    title: "World Boxing Rankings Update: Major Shifts in Pound-for-Pound List",
    excerpt: "Following a series of upset victories and dominant displays, the world boxing rankings have seen significant changes this month.",
    content: "<p>The latest rankings from the major sanctioning bodies are out, and there are some surprises in the pound-for-pound top ten. A new number one has emerged after a dominant performance last weekend.</p>",
    category: categories[5],
    author: "Sarah Chen",
    date: "2025-05-12",
    readTime: "6 min read",
    featuredImage: "https://images.pexels.com/photos/4761792/pexels-photo-4761792.jpeg?auto=compress&cs=tinysrgb&w=800",
    featured: false,
  },
];
